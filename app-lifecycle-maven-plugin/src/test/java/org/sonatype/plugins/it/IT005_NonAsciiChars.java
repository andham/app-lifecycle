...
public class IT005_NonAsciiChars
{
        ...
        throws IOException, URISyntaxException, VerificationException, JDOMException
    {
        ...
        final String itName = "005-nonAsciiChars";

        File dir = getTestDir( itName );
        ...
        Set<String> xpaths =
            Collections.singleton( "/plugin[name/text()=\"non-ascii name: åäö\"]" );
        ...
        File archive = new File( verifier.getBasedir(), "target/" + itName + "-" + version + ".jar" );
